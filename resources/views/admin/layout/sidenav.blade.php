    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
        <div class="brand-sidebar">
            <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="{{ route('admin') }}"><img class="hide-on-med-and-down"
                        src="frontend/content/lmg/Screenshot_12.png"
                        alt="materialize logo" /><span class="logo-text hide-on-med-and-down">Iconfurniture</span></a><a
        ...
        <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out"
            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        <li class="active"><a class="active" href="{{ route('admin') }}"><i
                                    class="material-icons">radio_button_unchecked</i><span
                                    data-i18n="eCommerce">IconFurniture</span></a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i
                ...
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        <li><a href="{{ route('Admin-ProductList') }}"><i class="material-icons">radio_button_unchecked</i><span
                                    data-i18n="Products Page">Products List</span></a>
                        </li>
                        <li><a href="{{ route('Admin-ProductAdd') }}"><i class="material-icons">radio_button_unchecked</i><span
                                    data-i18n="Pricing">Product Add</span></a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="bold"><a class="waves-effect waves-cyan " href="https://pixinvent.ticksy.com/"
